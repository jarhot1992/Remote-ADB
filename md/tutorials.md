...
10. [I suspect that my phone has been hacked. I suspect that my phone has malicious software. I suspect that my phone is being monitored by (my neighbor/ex-girlfriend/ex-boyfriend/boss/colleague/etc).](#i-suspect-that-my-phone-has-been-hacked-i-suspect-that-my-phone-has-malicious-software-i-suspect-that-my-phone-is-being-monitored-by-my-neighborex-girlfriendex-boyfriendbosscolleagueetc)
11. [Why does this app require storage permission?](#why-does-this-app-require-storage-permission)
12. [Why is it not possible to grant executable permission to files in /sdcard? chmod 777 /sdcard/*.sh,not working.](#why-is-it-not-possible-to-grant-executable-permission-to-files-in-sdcard-chmod-777-sdcardshnot-working)
13. [ADB connection takes too long.](#adb-connection-takes-too-long)
14. [ADB connection is unstable.](#adb-connection-is-unstable)
15. [ADB is already connected but cannot execute commands.](#adb-is-already-connected-but-cannot-execute-commands)
16. [ADB is already connected but toolbox cannot be initialized.](#adb-is-already-connected-but-toolbox-cannot-be-initialized)
17. [failed to start daemon.cannot connect to daemon adb reboot.ADB server didn't ACK](#failed-to-start-daemoncannot-connect-to-daemon-adb-rebootadb-server-didnt-ack)
18. [Just keeps showing app info in Android settings. Not working.](#just-keeps-showing-app-info-in-android-settings-not-working)
19. [can't execute: Permission denied](#cant-execute-permission-denied)
20. [I hope to use this application to monitor someone else's phone and invade their privacy.](#i-hope-to-use-this-application-to-monitor-someone-elses-phone-and-invade-their-privacy)
21. [I want to use this app to hack my (colleague/ex-girlfriend/ex-boyfriend/neighbor etc.)](#i-want-to-use-this-app-to-hack-my-colleagueex-girlfriendex-boyfriendneighbor-etc)
22. [This app not working.](#this-app-not-working)
23. [Unable to connect, not working properly.](#unable-to-connect-not-working-properly)
24. [I don't know the pairing passcode, and I can't enter it in the settings. I can't use pairing mode.](#i-dont-know-the-pairing-passcode-and-i-cant-enter-it-in-the-settings-i-cant-use-pairing-mode)
25. [Execute commands too slowly](#execute-commands-too-slowly)
26. [Why does my phone have this app?](#why-does-my-phone-have-this-app)
27. [Why is backing up APK and installing APK not supported now?](#why-is-backing-up-apk-and-installing-apk-not-supported-now)
28. [The command cannot be executed, or it is not functioning properly, or the command is not working.](#the-command-cannot-be-executed-or-it-is-not-functioning-properly-or-the-command-is-not-working)
29. [What should I do if an exception occurs when using a certain feature?](#what-should-i-do-if-an-exception-occurs-when-using-a-certain-feature)
30. [I want to learn adb](#i-want-to-learn-adb)
...
10. #### I suspect that my phone has been hacked. I suspect that my phone has malicious software. I suspect that my phone is being monitored by (my neighbor/ex-girlfriend/ex-boyfriend/boss/colleague/etc).
...
11. #### Why does this app require storage permission?
    1. The command 'ls'.
...
12. #### Why is it not possible to grant executable permission to files in /sdcard? chmod 777 /sdcard/*.sh,not working.
...
13. #### ADB connection takes too long.
...
14. #### ADB connection is unstable.
    1. Please check if your internet is working properly.
    2. Try restarting this application or resetting it (located at the bottom of this application's settings).This method is the simplest and most effective.
15. #### ADB is already connected but cannot execute commands.
    1. Please check if your internet is working properly.
    2. Try restarting this application or resetting it (located at the bottom of this application's settings).This method is the simplest and most effective.
16. #### ADB is already connected but toolbox cannot be initialized.
    1. Please check if your internet is working properly.
    2. Try restarting this application or resetting it (located at the bottom of this application's settings).This method is the simplest and most effective.
17. #### failed to start daemon.cannot connect to daemon adb reboot.ADB server didn't ACK
    1. Click 'Settings'.
    2. Click 'Port of adb server'
    3. Modify port (3000-49151)

18. #### Just keeps showing app info in Android settings. Not working.
    The issue has been fixed, please upgrade to the latest version.

19. #### can't execute: Permission denied
    For security reasons, the Android operating system does not allow granting executable permissions to files in the /sdcard (or external storage) by default. This is done to prevent potential security risks and to protect user devices from malicious software or apps abusing permissions. 
    ##### Solution:You can copy the file to the /data/local/tmp/ directory, which allows granting executable permissions.
    ```
    cp YOUR_FILE /data/local/temp/
...
20. #### I hope to use this application to monitor someone else's phone and invade their privacy.
    ##### Not support!!!!!

21. #### I want to use this app to hack my (colleague/ex-girlfriend/ex-boyfriend/neighbor etc.)
    ##### Not support!!!!!

22. #### This app not working.
...
23. #### Unable to connect, not working properly.
    This application has been tested. In most cases, if you have any questions about using this app,please Refer to [How to open and connect adb](#how-to-open-and-connect-adb)

24. #### I don't know the pairing passcode, and I can't enter it in the settings. I can't use pairing mode.
...
28. #### The command cannot be executed, or it is not functioning properly, or the command is not working.
    Every Android system is different, and so is the compatibility. Please check if your command is correct.
29. #### What should I do if an exception occurs when using a certain feature?
